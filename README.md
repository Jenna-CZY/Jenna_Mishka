...
```
    ...
    ## alpha_Intercept      0.25      0.03     0.18     0.31 1.00      851      765
    ## gamma_Intercept      0.33      0.03     0.27     0.39 1.00     1053      848
    ## lambda_Intercept     1.23      0.28     0.78     1.91 1.00      991     1113
    ## 
    ## Further Distributional Parameters:
    ##       Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    ## sigma     0.07      0.00     0.07     0.08 1.00     1491     1291
    ## 
...
```
    ...
    ## Regression Coefficients:
    ##                  Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    ## alpha_Intercept      0.21      0.03     0.15     0.27 1.00     1044     1316
    ## gamma_Intercept      0.36      0.03     0.31     0.42 1.00     1109     1402
    ## lambda_Intercept     1.03      0.20     0.73     1.52 1.00     1360     1653
    ## A_Intercept          0.06      0.01     0.05     0.08 1.00     2441     1645
    ## phi_Intercept       -0.84      0.12    -1.07    -0.61 1.00     2447     1802
    ## 
    ## Further Distributional Parameters:
    ##       Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    ## sigma     0.06      0.00     0.05     0.07 1.00     2226     2030
    ## 
    ## Draws were sampled using sampling(NUTS). For each parameter, Bulk_ESS
    ## and Tail_ESS are effective sample size measures, and Rhat is the potential
    ## scale reduction factor on split chains (at convergence, Rhat = 1).
